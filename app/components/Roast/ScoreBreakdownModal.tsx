          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="flex items-center justify-between p-5 border-b border-gray-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-semibold text-white">How We Score</h2>
                  <p className="text-sm text-gray-400">Your resume is evaluated on 4 key criteria</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 overflow-y-auto overscroll-contain p-5 space-y-4">
              ...
              <div className="text-center p-4 bg-gray-800/50 rounded-xl border border-gray-700">
                ...
                <p className="text-4xl font-bold text-white">{totalScore}<span className="text-lg text-gray-500">/100</span></p>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-1">
                            <h3 className="font-semibold text-white">{criterion.label}</h3>
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {criterion.factors.map((factor) => (
                              <span
                                key={factor}
                                className="text-xs px-2 py-0.5 bg-gray-800 rounded border border-gray-700 text-gray-400"
                              >
                                {factor}
                              </span>
                            ))}
              ...
              {/* Formula */}
              <div className="p-4 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-xl text-center border border-orange-500/20">
            ...
            <div className="p-4 border-t border-gray-800 bg-gray-900">
              <button
                onClick={onClose}
                className="w-full py-2.5 px-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg font-medium hover:from-orange-600 hover:to-red-600 transition-all"
              >
                Got it
              </button>
            </div>
