...
export function ReactionBar({ shareId, reactions, onReactionUpdate }: ReactionBarProps) {
  ...
  return (
    <motion.div
      ...
      className="mt-8 p-4 bg-gray-900 rounded-xl border border-gray-800"
    >
            ...
            <motion.button
              ...
              className={`
                ...
                ${isSelected
                  ...
                  : 'bg-gray-800 border border-gray-700 text-gray-300 hover:border-gray-600 hover:bg-gray-700'
                }
            ...
            >
              ...
              {count > 0 && (
                <span className={`
                  ...
                  ${isSelected ? 'bg-orange-500/30 text-orange-300' : 'bg-gray-700 text-gray-400'}
                `}>
                  {count}
                </span>
              )}
